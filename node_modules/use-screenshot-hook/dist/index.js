...
var useScreenshot = function (options) {
    var ref = (options || {}).ref;
    var _a = react.useState(), image = _a[0], setImage = _a[1];
    var _b = react.useState(false), isLoading = _b[0], setLoading = _b[1];
    var takeScreenshot = react.useCallback(function (type, options) { return __awaiter(void 0, void 0, void 0, function () {
        var tempImage, body, e_1;
        return __generator(this, function (_a) {
            switch (_a.label) {
                ...
                case 1:
                    ...
                    if (!(type === "jpg")) return [3 /*break*/, 3];
                    return [4 /*yield*/, lib_5((ref === null || ref === void 0 ? void 0 : ref.current) || body, options)];
                case 2:
                    tempImage = _a.sent();
                    return [3 /*break*/, 5];
                case 3: return [4 /*yield*/, lib_4((ref === null || ref === void 0 ? void 0 : ref.current) || body, options)];
                case 4:
                    tempImage = _a.sent();
                    _a.label = 5;
                case 5:
    ...
    var clear = react.useCallback(function () { return setImage(undefined); }, []);
    return { image: image, takeScreenshot: takeScreenshot, isLoading: isLoading, clear: clear };
};
