...
export default function Message() {
  ...
  useEffect(() => {
    ...
    fetch("https://tutor-platform.herokuapp.com/api/user_Detail")
      .then((data1) => {
        return data1.json();
      })
      .then((data) => {
  ...
  const getMessage = (idd) => {
    ...
    fetch(`https://tutor-platform.herokuapp.com/api/message/` + idd[0]._id)
      .then((data1) => {
        return data1.json();
      })
      .then((data) => {
  ...
  function handleClick(details) {
    ...
    fetch(`https://tutor-platform.herokuapp.com/api/conversation`, {
      method: "POST", // or 'PUT'
      headers: {
